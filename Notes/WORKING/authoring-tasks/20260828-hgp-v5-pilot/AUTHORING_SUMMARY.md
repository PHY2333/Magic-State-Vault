...
Manuscript 返修次数：**3**（draft 1→2→3→4）。
...
| `CONTRACT_AUDIT.md` | pass | draft 4 |
| `COLD_READ_AUDIT.md` | pass | draft 4 |
| `MANUSCRIPT_VERDICT.md` | pass | draft 4 |
| `INTEGRATION_PREVIEW.md` | ready | draft 4 |
...
- 计划删除当前第 39–70 行的重复/generic owner detail；保留第 3–38 行及第 71–447 行，尤其完整保留第 102–165 行 HGP 构造性证明。
- 新增 link 计划 0。
- 规划最小 frontmatter：`reference + guided + stable`。
